...
import {
  ...
  Users, MessageSquare, Tag, Gift, Store, LogOut,
  DollarSign, FileText, BarChart3, Clock, Shield, ShoppingCart,
} from "lucide-react";
...
const ITEMS: SidebarItem[] = [
  ...
  { label: "Abandoned Carts", to: "/admin/abandoned-carts", icon: <ShoppingCart className="h-4 w-4" /> },
];
