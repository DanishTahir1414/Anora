...
var services = { ["ssr"]: lazyService(() => import("./_ssr/ssr.mjs").then((n) => n.j)) };
...
var _lazy_eFU2BF = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_eFU2BF
	};
	return ((_m, p) => {
		return {
			data,
