...
const ALL_RPCS = [
  "has_admin_role", "is_admin", "is_staff",
  "get_analytics_summary", "get_sales_analytics", "get_revenue_analytics",
  "get_orders_by_status_distribution", "get_orders_by_category_distribution",
  "get_customer_analytics", "get_top_selling_products", "get_bottom_selling_products",
  "get_order_metrics", "get_orders_management", "get_order_details",
  "update_order_status", "create_return_request", "process_return",
  "create_refund", "process_refund",
  "get_products_management", "duplicate_product", "bulk_update_products", "bulk_delete_products",
  "get_categories_management", "create_category", "update_category", "delete_category",
  "get_inventory_management", "get_inventory_summary", "get_inventory_history",
  "get_inventory_alerts", "adjust_stock", "add_stock", "remove_stock", "resolve_alert",
  "get_customers_management", "get_customer_details", "get_customers_analytics",
  "get_reviews_management", "get_review_details", "get_review_stats",
  "approve_review", "reject_review", "delete_review",
  "get_coupons_management", "get_coupon_analytics",
  "create_coupon", "update_coupon", "delete_coupon", "toggle_coupon_status",
  "get_gift_cards_management", "get_gift_card_details", "get_gift_card_analytics",
  "create_gift_card", "toggle_gift_card_status", "redeem_gift_card",
  "get_finance_dashboard", "get_revenue_trend", "get_tax_trend",
  "get_refund_trend", "get_discount_trend", "get_monthly_comparison", "get_yearly_comparison",
  "get_invoices_management", "get_invoice_details", "generate_invoice", "update_invoice_status",
  "get_revenue_report", "get_financial_report", "get_customer_report",
  "get_inventory_report", "get_export_data",
  "get_activity_timeline", "get_audit_logs", "get_admin_activity",
  "get_failed_login_summary", "get_active_sessions", "get_security_overview",
  "end_user_session", "mark_cart_recovered", "mark_cart_converted",
  "record_admin_activity", "check_login_lockout", "record_failed_login",
  "get_abandoned_carts", "get_abandoned_cart_analytics",
];
